...
typedef enum upng_error {
    ...
    UPNG_ENOMEM,  // memory allocation failed
    UPNG_ENOTFOUND, // resource not found (file missing)
    UPNG_ENOTPNG, // image data does not have a PNG header
    UPNG_EMALFORMED, // image data is not a valid PNG image
    UPNG_EUNSUPPORTED, // critical PNG chunk type is not supported
    UPNG_EUNINTERLACED, // image interlacing is not supported
    UPNG_EUNFORMAT, // image color format is not supported
